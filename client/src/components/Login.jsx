        ...
        <div className='w-screen h-screen'>
            <div className='flex flex-row h-full'>
                        ...
                        <form onSubmit={handleSubmit} method="POST">
                            <div className='flex gap-8 flex-col'>
                                <div className='flex items-center gap-4 shadow border rounded-xl w-full py-4 px-7 text-gray-700 leading-tight'>
                                    ...
                                    <input
                                        className="appearance-none focus:outline-none focus:shadow-outline text-xl"
                                        id="email"
                                        type="email"
                                ...
                                <div className='flex items-center gap-4 shadow border rounded-xl w-full py-4 px-7 text-gray-700 leading-tight'>
                                    ...
                                    <button
                                        type='button'
                                        onClick={() => setToggelPassword((prev) => !prev)}
                                    >
                                        {toggelPassword
                                            ? <IoMdEye style={{ color: "rgba(23, 17, 91, 0.6)", fontSize: "2em" }} />
                ...
                <div className='basis-1/2 hidden justify-center items-end w-full shrink-0 tablet:flex'>
                    <img src="https://www.freeiconspng.com/uploads/bus-png-4.png" className='w-full' alt="Bus" />
                </div>
            </div>
        </div>
    );
